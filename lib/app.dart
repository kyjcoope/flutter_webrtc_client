...
class WebRTCStreamPage extends StatefulWidget {
  const WebRTCStreamPage({Key? key}) : super(key: key);

  @override
  _WebRTCStreamPageState createState() => _WebRTCStreamPageState();
}

class _WebRTCStreamPageState extends State<WebRTCStreamPage> {
  final _localRenderer = RTCVideoRenderer();
  RTCPeerConnection? _peerConnection;
  MediaStream? _remoteStream;

  // IMPORTANT: REPLACE WITH YOUR COMPUTER'S LOCAL IP
  final String _signalingServerUrl = "http://YOUR_COMPUTER_IP:8080";
